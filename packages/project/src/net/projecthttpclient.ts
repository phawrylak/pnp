...
export class ProjectHttpClient implements RequestClient {

    private _digestCache: DigestCache;

    constructor(private _impl: HttpClientImpl = ProjectRuntimeConfig.fetchClientFactory()) {
    ...
    public fetch(url: string, options: FetchOptions = {}): Promise<Response> {
        ...
        mergeHeaders(headers, ProjectRuntimeConfig.headers);
